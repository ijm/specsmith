...
This document defines the requirements and constraints for writing standalone Python targeting Python 3.10+ that adhere to the PEP 8 style guide, use modern typing features, and follow standard conventions for command-line tools.
...
* PY01 Scripts MUST be compatible with Python version 3.10 or greater. Ⓟ
...
* PY05 Scripts MAY use features from Python 3.10 and later, including structural pattern matching. Ⓗ
...
* PY21 Scripts MUST NOT use deprecated Python 3.10+ features. Ⓟ
* PY22 Scripts MUST NOT rely on features that are only available in Python 3.11 or later. Ⓟ
