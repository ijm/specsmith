...
The idea of documentation as code, or specification as code, isn't new; it's been around for decades (ref). But this is a new twist, with new rules, new tricks, and new shortcuts. Coding agents now allow us to "compile" documentation into other artifacts like code, tests, evaluations, or other documentation.
